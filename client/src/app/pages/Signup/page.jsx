...
// import { Mail, LockKeyhole, ArrowRight, UserRound } from "lucide-react";
...
//         })
//         .catch(err=>{
//             console.log(err, "something wrong while creating user");
...
//   return (
//     <main className="min-h-screen bg-gradient-to-r from-[#29205f] via-[#202451] to-[#0c3141] px-5">
